    ...
    <div className='contact'>
      <div className='container'>
        ...
        <div className='content flexsb'>
          ...
          <div className='left'>
            <iframe width="400" height="360" id="gmap_canvas" src="https://maps.google.com/maps?q=1675%20N%20Main%20St,%20Orange,%20CA%2092865&t=k&z=19&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
          </div>
        </div>
      </div>
      </div>
