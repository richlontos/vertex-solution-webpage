...
const BlogH = ({ content, alternative }) => {
  return (
    <section
    style={{"paddingTop":"100px"}}
      className={`flex ${
        alternative ? "md:flex-row-reverse" : "md:flex-row"
      } flex-col gap-6 py-20 md:px-28 px-4 items-center`}
    >
      ...
      <div className="flex-1">
        ...
        <p style={{"color":"lightgray"}} className="text-sm text-gray-600 md:w-2/3 leading-relaxed py-5">
          {content.des}
        </p>
